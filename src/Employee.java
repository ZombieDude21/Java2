public class Employee {
    ...
    public static void main (String[] args) {
        Employee jane = new Employee(123 , "Jane");
        System.out.println(jane);
        jane.setSalary(24000);
        System.out.println(jane);
        System.out.println("Applying manager");
        jane.setManager("Barabra Forbes");
        System.out.println(jane);
        System.out.println("Applying salary raise");
        jane.setSalary(25200);
        System.out.println(jane);
        System.out.println("Applying job title");
